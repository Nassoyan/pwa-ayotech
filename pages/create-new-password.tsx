...
import { asyncResetPasswordThunk, forgotMessageSelector } from "@/redux/slices/authentication/resetPasswordSlice";
...
function NewPassword() {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    router?.query?.token && dispatch(asyncResetPasswordThunk({
      password:password,
      token:queryToken,
              ...
              <div className="input_area">
                <form onSubmit={handleSubmit} className="login_form">
                  ...
                  <div className="login_input_div">
                    ...
                    <p style={{color:"green"}}>{forgotMessage && forgotMessage}</p>
                  </div>
